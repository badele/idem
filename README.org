...
| typescript | ✅  | ✅ | ✅ | ✅   | ✅  | ✅ | ~(javascript +lsp +tree-sitter)~, prettier, typescript-language-server, vscode-eslint-language-server |
...
5. Check Emacs configuration: ~doom doctor~ or ~M-x async-shell-command RET doom doctor RET~
